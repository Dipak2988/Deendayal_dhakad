...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001964648589').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002245762167'))  # Notification of those who verify will be sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/DSSBackupChannel')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/DSSBackupChannel')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/DSSBackupChannel')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002244828112')).split()]
